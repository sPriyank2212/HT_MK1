...
C_SRCS += \
../Core/Src/bsp/board.c 

OBJS += \
./Core/Src/bsp/board.o 

C_DEPS += \
./Core/Src/bsp/board.d 
...
clean-Core-2f-Src-2f-bsp:
	-$(RM) ./Core/Src/bsp/board.cyclo ./Core/Src/bsp/board.d ./Core/Src/bsp/board.o ./Core/Src/bsp/board.su
